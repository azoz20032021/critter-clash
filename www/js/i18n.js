...
(function (global) {
  ...
  const STR = {
    ...
    double_ad_note:  { ar: 'شاهد إعلاناً قصيراً واحصل على ضعف الأرواح. اختياري تماماً — أرواحك محفوظة في الحالتين.',
    ...
    mut_intro:       { ar: 'حوّل مخلوقك إلى نسخة فريدة: ندرة جديدة، صفة خاصة، وشكل لا يملكه أحد غيرك. الطفرات تبقى بعد البعث.',
